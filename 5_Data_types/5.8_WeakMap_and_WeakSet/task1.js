...
/*
  ...
  чтобы можно было однозначно сказать, было ли прочитано это сообщение для каждого объекта 
  сообщения.
...
function read(obj) {
  readMessages.add(obj);
}

function hasMessageRead(obj) {
  return readMessages.has(obj);
}

read(messages[0]);

console.log(hasMessageRead(messages[0]));
console.log(hasMessageRead(messages[1]));