...
function read(obj) {
  readMessages.set(obj, new Date());
}

function getDateReadMessage(obj) {
  return readMessages.get(obj) || 'Небыло прочитано';
}

read(messages[0]);

console.log(getDateReadMessage(messages[0]));
console.log(getDateReadMessage(messages[1]));