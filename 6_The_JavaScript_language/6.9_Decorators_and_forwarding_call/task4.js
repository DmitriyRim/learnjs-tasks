...
указателя и получать его местоположение. Во время активного использования мыши эта 
...
function throttle(update, ms) {
    ...
    function wrapper(...args) {
        ...
        setTimeout(() => {
            statusThrottle = false;
            if(nextArgs !== null) {
                update.call(nextThis, ...nextArgs);
            }
        }, ms)
    }
    return wrapper;
